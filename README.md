This project is a potato leaf disease detection model. The current github repo contains the FastAPI service code as well as the frontend website using ReactJS. 
